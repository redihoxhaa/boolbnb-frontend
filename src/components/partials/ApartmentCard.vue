    ...
    <div class="apartment-image-container m-0">
      <div class="apartment-icon">
        <div class="icon-sponsor">
          <div
            v-if="apartment.sponsorships && apartment.sponsorships.length"
            class="p-1"
          >
            <div
              v-if="
        ...
        <div class="icon-redirect">
          <div
            class="arrow-icon"
            role="button"
            @click="visitApartment(apartment.id)"
          >
      ...
      <div class="apartment-image">
        <img
          :src="this.store.imagesAPI + apartment.images.split(',')[0]"
          alt="Apartment Image"
          v-if="apartment.images"
        />
        <img
          src="https://victorsandbox.myshopify.com/cdn/shop/products/property-placeholder_grande.jpg?v=1482778691"
          class="card-image"
          alt="Apartment Image"
          v-else
        />
    ...
    <div class="apartment-info">
      ...
      <ul class="d-flex mt-3 gap-4 list-unstyled align-items-center">
        ...
        <li class="d-flex gap-2 align-items-center">
          <img
            class="bathroom-icon"
            src="../../assets/img/bathrooms_icon.svg"
            alt="bathrooms"
          />
          {{ apartment.bathrooms }}
        </li>
